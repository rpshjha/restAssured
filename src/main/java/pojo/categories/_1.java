...
public class _1 {
	...
	private List<CategoryDetermination> categoryDetermination = null;
	 ...
	 * @param _new
	 */
	public _1(Integer id, String name, Integer tenureStart, Integer tenureEnd,
			List<CategoryDetermination> categoryDetermination, Boolean active, Boolean _new) {
		super();
		this.id = id;
		this.name = name;
	...
	public List<CategoryDetermination> getCategoryDetermination() {
		return categoryDetermination;
	}

	public void setCategoryDetermination(List<CategoryDetermination> categoryDetermination) {
		this.categoryDetermination = categoryDetermination;
	}
